  ...
  return (
    <div className="bg-canvas flex min-h-screen items-center justify-center px-4">
      <div className="max-w-md text-center">
        <h1 className="text-gradient-warm text-7xl font-bold">404</h1>
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="bg-gradient-warm text-primary-foreground inline-flex items-center justify-center rounded-xl px-4 py-2 text-sm font-medium"
          >
            Go to marketplace
          </Link>
        </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ArtisanLink — AI market linkage for artisans" },
      {
        name: "description",
        content:
          "ArtisanLink helps artisans catalog handmade products with AI, in their own language, and reach buyers directly.",
      },
      { name: "author", content: "ArtisanLink" },
